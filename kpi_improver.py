...
def build_nlp_html_section(analysis: dict) -> str:
    sentiment_colors = {
    ...
    <div class="section">
      ...
      <div style="background:#eeedfe;border-radius:6px;padding:8px 12px;
        ...
        LLM analysis using Claude — {total} comments analyzed.
...
def main() -> None:
    ...
    nlp_analysis = analyze_survey_comments_with_llm(SAMPLE_SURVEY_COMMENTS, client)
    nlp_html = build_nlp_html_section(nlp_analysis)
